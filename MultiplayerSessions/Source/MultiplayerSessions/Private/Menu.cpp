	...
	else
	{
		...
		if(GEngine)
		{
			GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Red,
				FString(TEXT("Failed to Created Successfully!")));
		}
	}
}
...
void UMenu::OnFindSessions(const TArray<FOnlineSessionSearchResult>& SessionResults, bool bWasSuccessful)
{
	...
	//TODO - this will just pick the first matching session... 
...
void UMenu::JoinButtonClicked()
{
	...
	if(MultiplayerSessionsSubsystem)
	{
		MultiplayerSessionsSubsystem->FindSessions(10000); //10000 for testing with Steam - generic game test code 480.
	}
}
